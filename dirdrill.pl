...
my ($dir, @parts, $error, $starttime, $runtime, $endtime, $runmin, $year, 
$month, $day, $tm, $date, $topdir, $foldername, $slash2, $count, $runhour, 
$starttime, $runtime, $endtime, $runmin, $year, $month, $day, $tm, $date,
$file, $path_length, $totsize, $warn1, $warn2, $path_length, $drilldir, 
$drilltopdir,$drillfoldername,$slash3,$lcasefoldername);
...
open(OUT, "> DirDrill_and_users_output.csv") or die("Couldn't open DirDrill_and_users_output.csv\n");
open(ERRORLOG, "> DirDrill_and_users_errorlog.csv") or die ("Couldn't open DirDrill_and_users_errorlog.csv\n");
